...
#+end_example
  =**= 可以表示任何级别的目录。
  =**/debug/= 会忽略任何debug目录， =*/debug/= 只会忽略一级目录下的debug目录。
  =*= 与 =*/= 的区别：前者忽略所有非目录，后者忽略所有目录；必须要二者配合才能忽略所有文件。
* 颜色
...
<center> <a class="lightbox" href="./images/rebase.png"> <img class="lightbox " title="jQuery.lightbox" src="./images/rebase.png" width="300"> </a> </center>
